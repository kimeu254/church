...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box table-responsive">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Zones</h4>
					<button class="btn btn-success pull-right" onclick="add_zones()"><i class="glyphicon glyphicon-plus"></i> Add Zones</button>
				</div>
			</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title">Manage Zones</h3>
			</div>
          ...
          <input type="hidden" value="{{ Auth::user()->church_id }}" id="church_id" name="church_id" />
					<div class="form-body">
						<div class="form-group row">
							...
							<div class="col-md-9">
								<input name="zone_name" placeholder="Zone Name" class="form-control" type="text">
							</div>
						</div>
						<div class="form-group row">
  ...
  function edit_zones(id)
  {
      ...
      $.ajax({
      	...
      	success: function(data)
      	{
      		...
      		$('[name="zone_name"]').val(data[0].zone_name);
       ...
       $.ajax({
          ...
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       	...
       	success: function(data)
       	{
              ...
              swal({   title: "Success",   
                 text: "Zone has been Added/Updated successfully.",
                 timer: 2500,
                 type: "success",   
                 showConfirmButton: false 
            }); 
