...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box table-responsive">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="pull-left page-title">Expense Types</h4>
                        <button class="btn btn-success pull-right" onclick="add_expense_type()"><i class="glyphicon glyphicon-plus"></i> Add Expense Type</button>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function add_expense_type()
        {
            ...
            $('.modal-title').text('New Expense Type'); // Set Title to Bootstrap modal title
        }

        function edit_expense_type(id)
        {
            save_method = 'update';
            $('#form')[0].reset(); // reset form on modals
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('[name="expense_type"]').val(data[0].expense_type);
                    $('[name="status"]').val(data[0].status);



                    $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                    $('.modal-title').text('Edit Expense Type'); // Set title to Bootstrap modal title
